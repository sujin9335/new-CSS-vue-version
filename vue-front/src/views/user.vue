                ...
                <div class="col-12 mb10">
                    <div class="search-box">
                        <div class="row form_width_80">
                            ...
                            <div class="col-1">
                                <div class="fr">
                                    <select v-model="limitPage" class="form-control">
...
import upsertModal from '@/components/modals/userUpsert.vue';
